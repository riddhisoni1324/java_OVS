...
public RegGetSet(long p,String e)
{
p=getphno1();
e=getemail1();
}
...
System.out.println("in method email....."+b);
...
public int numdigits(long p1)
	...
	if(!(p.equals("")) && !(p1.equals("")) && p.equals(p1) && p.length()>=6 && p.length()<=10)
	{
	return true;
	}
	return false;
